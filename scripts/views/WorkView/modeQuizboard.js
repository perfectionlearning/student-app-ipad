...
;(function() {
	...
	var layoutOptions = {
		...
		hideSteps: true,		// Don't show the steps button
		quizboardUpButton: true	// "Up to problem list" button
	};
	...
	//=======================================================
//	app.modes.register("Quizboard", API);
	app.modes.register("QZ", API);
