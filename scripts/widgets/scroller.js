...
framework.widget.scroller = function()
{
	...
	//=======================================================
	// Add the widget, resize the stage
	//=======================================================
	function resizeToFit(widget, callback)
	{

		var curStageSize = fw.stageSize();
		var curScrollPosition = $(window.parent).scrollTop();//$(window).scrollTop();

	//	app.resizeStageHeight(curStageSize[0] + widget.height() + 160);
	//	console.log('widget.height() ' + widget.height())


		$(window.parent).scrollTop(curScrollPosition + widget.height());
	...
	{
		return resizeToFit(items[items.length-1], callback);
	}
	...
	this.addWidget = function(widget, options)
	{
		...
		var allStepHeight = app.style.stageHeight;
		for (var i = 0, len = items.length; i < len; i++) {
				allStepHeight += items[i].height();
		}

		app.resizeStageHeight(allStepHeight);
